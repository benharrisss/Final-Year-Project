#!/bin/bash
#SBATCH --job-name=summarised_tests
...
# Paths
SCRIPT=/users/sc23bh2/baseline_testing/trained_tests_LLM.py
INPUT=/users/sc23bh2/baseline_testing/data/2200-phishing+legitimate.csv
OUTDIR=/users/sc23bh2/baseline_testing/results/slurm_job_results/summarised_results
MODELDIR=/scratch/sc23bh2/models

# Models to test
models=(
  "gemma-2-9b-it"
  "deepssek-llm-7b-chat"
...
for m in "${models[@]}"; do
  ...
  out_csv="${OUTDIR}/results_${m}_2200-SUM.csv"
